...
python BGR/main.py --batch_size=8 --num_epochs=100 --wandb_online --wandb_plot_logging --wandb_project_name=BGR_End2EndExperiments --experiment_type=end2end_lstm_embed