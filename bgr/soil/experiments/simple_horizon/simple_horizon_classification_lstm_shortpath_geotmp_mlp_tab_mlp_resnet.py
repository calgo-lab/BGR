...
class SimpleHorizonClassificationWithLSTMShortPathGeotempsMLPTabMLPResNet(Experiment):
    def __init__(self, training_args: 'TrainingArgs', target: str, dataprocessor: HorizonDataProcessor):
        ...
        defaults = SimpleHorizonClassificationWithLSTMShortPathGeotempsMLPTabMLPResNet.get_experiment_hyperparameters()
        for key in defaults:
