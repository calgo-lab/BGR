...
from bgr.soil.modelling.soilnet import SoilNet_MaskedSegment
...
class End2EndLSTMResNetEmbed_Masking(Experiment):
    def __init__(self, training_args: 'TrainingArgs', target: str, dataprocessor: HorizonDataProcessor):
        ...
        self.hyperparameters = End2EndLSTMResNetEmbed_Masking.get_experiment_hyperparameters()
    ...
    def get_model(self) -> nn.Module:
        return SoilNet_MaskedSegment(
            ...
            segments_mask_fading_strength= self.hyperparameters['segments_mask_fading_strength'],
            segments_mask_upper_boundary_weight= self.hyperparameters['segments_mask_upper_boundary_weight'],
    ...
    def _run_model(self, data_loader, device, model, mode='val', optimizer=None):
        ...
        for batch in data_loader_tqdm:
            padded_images, image_mask, _, padded_true_depths, padded_segments_tabulars_labels, padded_true_horizon_indices = batch
            padded_images, image_mask, padded_true_depths, padded_segments_tabulars_labels, padded_true_horizon_indices = (
    ...
    def get_experiment_hyperparameters():
        return {
            ...
            'segments_mask_fading_strength': 0.1,
            'segments_mask_upper_boundary_weight': 1.5,
