...
class End2EndLSTMEmbed(Experiment):
    ...
    def train_and_validate(self,
        ...
        for epoch in range(1, self.training_args.num_epochs + 1):
            ...
            logger.info(
                ...
                f"- Horizon Precision@{self.tab_topk}: {train_horizon_metrics['train_Horizon_precision_at_k']:.4f}\n"
                f"- Horizon Recall@{self.tab_topk}: {train_horizon_metrics['train_Horizon_recall_at_k']:.4f}\n"
                "\nValidation:\n"
                ...
                f"- Horizon Precision@{self.tab_topk}: {val_horizon_metrics['val_Horizon_precision_at_k']:.4f}\n"
                f"- Horizon Recall@{self.tab_topk}: {val_horizon_metrics['val_Horizon_recall_at_k']:.4f}\n"
    ...
    def test(self,
        ...
        logger.info(
            ...
            f"- Horizon Precision@{self.tab_topk}: {test_horizon_metrics['test_Horizon_precision_at_k']:.4f}\n"
            f"- Horizon Recall@{self.tab_topk}: {test_horizon_metrics['test_Horizon_recall_at_k']:.4f}\n"
            "--------------------------------"
        )
