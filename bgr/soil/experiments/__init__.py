...
from .end2end.end2end_lstm_resnet_masking import End2EndLSTMResNetEmbed_Masking
...
def get_experiment(experiment_type, training_args, target, dataprocessor) -> Experiment:    
    ...
    elif experiment_type == "end2end_lstm_resnet_masking":
        return End2EndLSTMResNetEmbed_Masking(training_args, target, dataprocessor)
    else:
...
def get_experiment_hyperparameters(experiment_type) -> dict:
    if experiment_type == "simple_depths_geotmp":
        ...
        return End2EndLSTMResNetEmbed_Masking.get_experiment_hyperparameters()
    else:
        raise ValueError(f"Unknown experiment type: {experiment_type}")