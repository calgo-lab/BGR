...
class SimpleDepthsMaskedResNetLSTM(Experiment):
    def __init__(self, training_args: 'TrainingArgs', target: str, dataprocessor: HorizonDataProcessor):
        ...
        self.hyperparameters = SimpleDepthsMaskedResNetLSTM.get_experiment_hyperparameters()
    ...
    def get_model(self) -> nn.Module:
        return SimpleDepthModelMaskedResNetLSTM(
